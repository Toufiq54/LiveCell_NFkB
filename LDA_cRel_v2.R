...
datt <- read.csv("pBMDM_Y_signaling_features_cRel.csv")
...
for (i in 1:10){
  ...
  filename = (paste("T://LMBI//021Transcription_Systems_Dynamics_and_Biology//Toufiq//R studio project//DKin project2//Confusion matrix//confusion matrix 10fold_CV//Confusion_LDA_cRel_",i,".CSV",sep=""))
