...
datt <- read.csv("pBMDM_Y_signaling_features_cRel_KernelKnn.csv")
...
for (i in 1:10){ 
  ...
  # save the confusion matrix in .CSV file
  filename = (paste("T://LMBI//021Transcription_Systems_Dynamics_and_Biology//Toufiq//R studio project//DKin project2//Confusion matrix//KernelKNN_10fold_CV_confusionMatrix//KernelKNN_canberra_k=7_",i,"_cRel_",".CSV",sep=""))
